export default function(part) {
  ...
  points.neckbottom = points.neckorigin.shift(-90,options.neckdepthback);

  
  
  
  //control points
 points.neckcp1 = points.neckright.shift(-90-options.neckcprightangleback,options.neckcprightspreadback*points.neckright.dy(points.neckbottom));
 points.neckcp2 = points.neckbottom.shift(0+options.neckcpbottomangleback,-options.neckcpbottomspreadback*points.neckright.dx(points.neckbottom));
