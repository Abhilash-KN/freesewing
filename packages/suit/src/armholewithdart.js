export default function(part) {
  ...
  .line(points.armholedartmidcopy)

  points.armholedartfoldref = points.armholedartmid.shiftFractionTowards(points.armholedartmidcopy,0.5)
  paths.armholedartfold = new Path()
  .move(points.pivot)
  .line(points.armholedartfoldref)
  .attr("class", "lining dashed");
