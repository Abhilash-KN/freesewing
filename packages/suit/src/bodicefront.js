export default function (part) {
  ...
  points.one = points.nine.translate(-(measurements.highBust / 4 + inch / 2), measurements.naturalWaistToUnderarm-inch/2 +options.waistverticalposition);
  points.four = points.one.shift(0, measurements.naturalWaist / 4 + inch / 8+options.waistdartwidth+ options.waistgather);
