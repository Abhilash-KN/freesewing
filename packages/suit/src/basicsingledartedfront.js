export default function (part) {
  let { Point, points, Path, paths, measurements, options,utils } = part.shorthand();
  const inch = 25.4;
  ...
  if (options.frontdart === 'no') {
    ...
    paths.frontdart = new Path()
      ...
      .attr("class", "lining dashed");
      if(options.slit === 'yes')
      {points.slit = utils.beamsIntersect(points.leftDartC,points.leftDartPoint,points.lHem,points.rHem);
      points.slitend = points.slit.shiftTowards(points.leftDartPoint,options.slitlength)
      paths.slit = new Path()
      .move(points.slit)
      .line(points.slitend)}
  }
    ...
    points.leftDartPoint = points.leftDartPoint.rotate(rotationangle,points.pivot);
      ...
      if(options.slit === 'yes')
      {points.slit = utils.beamsIntersect(points.waistdartfoldref,points.leftDartPoint,points.lHem,points.rHem);
      points.slitend = points.slit.shiftTowards(points.leftDartPoint,options.slitlength)
      paths.slit = new Path()
      .move(points.slit)
      .line(points.slitend)}
